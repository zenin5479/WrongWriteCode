...
namespace WrongWriteCode
{
   internal class Program
   {
      static void Main(string[] args)
      {
         ...
         {
            // Совместимость размеров: если матрица A имеет размер m × n, а матрица B — n × k, то результирующая матрица будет m × k
            // Ошибка при несовместимости: если n не совпадает, возникнет ошибка
