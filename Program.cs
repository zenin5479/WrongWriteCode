...
namespace WrongWriteCode
{
   internal class Program
   {
      static void Main(string[] args)
      {
         ...
         Console.WriteLine("--------------------------------------------------------------------------");
         Console.WriteLine("Поиск в двумерном целочисленном массиве чисел, сумма цифр которых больше их произведения");
         Console.WriteLine("--------------------------------------------------------------------------");
         ...
         void NumberArray()
         {
            ...
            else Console.WriteLine("Массив не содержит элементов, для которых выполняется условие");
         }
